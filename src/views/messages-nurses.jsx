      ...
      <div className="messages-nurses-container01">
        <div className="messages-nurses-container02">
          <div className="messages-nurses-container03">
            ...
            <svg viewBox="0 0 1024 1024" className="messages-nurses-icon07">
            ...
            <Link to="/dashboard" className="messages-nurses-navlink">
              <img
                alt="image"
                src="/LAMPARA/logo1-200h.png"
                className="messages-nurses-image"
              />
            </Link>
            <Link to="/dashboard-nurses" className="messages-nurses-navlink1">
              <h1 className="messages-nurses-text1">LAMPARA</h1>
            </Link>
            <Link to="/dashboard-nurses" className="messages-nurses-navlink2 button">
              Scheduler
            </Link>
            <Link to="/dashboard-nurses" className="messages-nurses-navlink3 button">
              Dashboard
            </Link>
            <Link
              to="/messages-nurses"
              className="messages-nurses-navlink4 button"
            >
              Messages
            </Link>
            <Link
              to="/schedule-nurses"
              className="messages-nurses-navlink6 button"
            >
              Schedule
            </Link>
            <Link to="/account-nurses" className="messages-nurses-navlink7 button">
              Account Settings
            </Link>
          </div>
        </div>
      ...
      <div className="messages-nurses-container04">
        ...
        <div className="messages-nurses-container05">
          ...
          <div className="messages-nurses-container09">
            ...
            <svg viewBox="0 0 1024 1024" className="messages-nurses-icon24">
